...
public class ExtBSTDriver 
{
  public static void main(String[] args)
  {
    ...
    System.out.println("Expect '0' recHeight:\t" + test.publicRecHeight());
    System.out.println("Expect '0' height:\t" + test.height());
...
*/
    ...
    System.out.println("Expect '1' recHeight:\t" + test.publicRecHeight()); 
    System.out.println("Expect '1' height:\t" + test.height());       
...
*/
    ...
    test = new ExtendedBST<String>();
//    test = new ExtendedBST<String>(comp);
    ...
    System.out.println("Expect '2' recHeight:\t" + test.publicRecHeight()); 
    System.out.println("Expect '2' height:\t" + test.height());      
...
*/
    ...
    System.out.println("Expect '4' recHeight:\t" + test.publicRecHeight()); 
    System.out.println("Expect '4' height:\t" + test.height());      


    test.add("aaa"); test.add("comma"); test.add("ark");
    
    System.out.println("Expect '5' recHeight:\t" + test.publicRecHeight()); 
    System.out.println("Expect '5' height:\t" + test.height());      
    ...
    // Multi element tree
//    test = new ExtendedBST<String>(new ReverseStringComparator());
